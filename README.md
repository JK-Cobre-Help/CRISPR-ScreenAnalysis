...
| *Control (x-axis) vs treatment (y-axis) Beta Scores, colored by FDR*                  | *Control vs Treatment Beta Scores with lowest treatment FDR genes labeled*                 |
...
| *β difference (treat − ctrl) vs −log10(FDR) with top hits labeled*                    | *β difference (treat − ctrl) vs −log10(FDR) with lowest FDR labeled*                       |
