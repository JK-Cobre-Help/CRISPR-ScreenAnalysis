...
| 1. **β Score Histograms**                                                             | 2. **β Score Normalization Comparison**                                                    |
| :-----------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------: |
| <img src="/images/beta_hist.png" width="300">                                         | <img src="/images/beta_norm.png" width="300">                                              |
| *Side-by-side histograms for control vs treatment*                                    | *Density comparison of raw, cell-cycle, and loess*                                         |

| 3. **β vs β Scatter Plot**                                                            | 4. **β vs β Scatter Plot (Labeled)**                                                       |
| :-----------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------: |
| <img src="/images/beta_scatter.png" width="300">                                      | <img src="/images/beta_scatter_labeled.png" width="300">                                   |
| *Control (x) vs treatment (y), color by FDR*                                          | *Top-ranked genes labeled for quick inspection*                                            |

| 5. **Volcano Plot**                                                                   | 6. **QC – Gini Index**                                                                     |
| :-----------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------: |
| <img src="/images/volcano_diff_vs_neglog10FDR.png" width="300">                       | <img src="/images/qc_gini.png" width="300">                                                |
| *β difference (treat − ctrl) vs −log10(FDR)*                                          | *Evenness of sgRNA read distribution per sample*                                           |

| 7. **QC – Zero Count sgRNAs**                                                         | 8. **QC – Mapping Rates**                                                                  |
| :-----------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------: |
| <img src="/images/qc_zero_counts.png" width="300">                                    | <img src="/images/qc_maprates.png" width="300">                                            |
| *Number of sgRNAs with zero reads per sample*                                         | *Per-sample mapping rates from count summary*                                              |
