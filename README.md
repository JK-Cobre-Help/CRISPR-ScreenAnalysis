...
```
wget https://github.com/KirklandLab/CRISPR-ScreenAnalysis/releases/download/v1.1.0/CRISPR-ScreenAnalysis-1.1.0.tar.gz
tar -xzf CRISPR-ScreenAnalysis-1.1.0.tar.gz
rm CRISPR-ScreenAnalysis-1.1.0.tar.gz
cd CRISPR-ScreenAnalysis-1.1.0
```
9B. Load modules
```
module purge
