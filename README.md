...
| 3. **QC – Gini Index**                                                                | 4. **β Score Normalization Comparison**                                                    |
| :-----------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------: |
| <img src="/images/qc_gini.png" width="300">                                           | <img src="/images/beta_norm.png" width="300">                                              |
| *Evenness of sgRNA read distribution per sample*                                      | *Density comparison of raw, cell-cycle, and loess*                                         |

| 5. **β Score Histograms**                                                             | 6. **β vs β Scatter Plot**                                                                 |
| :-----------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------: |
| <img src="/images/beta_hist.png" width="300">                                         | <img src="/images/beta_scatter.png" width="300">                                           |
| *Side-by-side histograms for control vs treatment*                                    | *Control (x) vs treatment (y), color by FDR*                                               |

| 7. **β vs β Scatter Plot (Labeled)**                                                  | 8. **Volcano Plot**                                                                        |
| :-----------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------: |
| <img src="/images/beta_scatter_labeled.png" width="300">                              | <img src="/images/volcano_diff_vs_neglog10FDR.png" width="300">                            |
| *Top-ranked genes labeled for quick inspection*                                       | *β difference (treat − ctrl) vs −log10(FDR)*                                               |
